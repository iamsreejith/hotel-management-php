...
<div class="container" style="margin-top: 150px;">
        ...
        <span class="card-title center">ADD NEW FOOD ITEM</span>
          ...
          <div class="row">
            <div class="input-field">
              <input  id="first_name" type="text"  name="foodname" class="validate">
          ...
          <div class="row">
            <div class="input-field">
              <input id="text" type="text" class="validate"  name="cost">
          ...
          <p>
    <label>
      <input class="with-gap" name="r1" type="radio"  value="1"  />
      <span>Breakfast</span>
    </label>
  </p>
  ...
  <p>
    <label>
      <input class="with-gap" name="r1" type="radio"  value="2"  />
      <span>Lunch</span>
    </label> 
  </p>
  ...
  <p>
    <label>
      <input class="with-gap" name="r1" type="radio"  value="3"  />
      <span>Dinner</span>
    </label>
  </p>
